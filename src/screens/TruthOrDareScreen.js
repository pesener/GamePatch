    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Players take turns choosing between answering a question truthfully or 
          performing a dare. The goal is to have fun, bond, and challenge each 
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Players take turns being asked "Truth or Dare?" by the group. Depending 
          on their choice, they either answer a question honestly or complete a dare.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Truth:
          {"\n"}• The player must honestly answer a question asked by the group
          {"\n"}• Example: "What's the most embarrassing thing you've ever done?"
          {"\n\n"}Dare:
          {"\n"}• The player must complete a challenge or task given by the group
        ...
        <Text style={styles.text}>
          ...
          penalty (e.g., lose a point, take a drink, or perform an extra challenge).
        </Text>

        <Text style={styles.boldText}>4. Passing the Turn</Text>
        <Text style={styles.text}>
          After completing their turn, the current player picks the next person 
          (or the bottle determines it).
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Players must complete a dare within a set time limit (e.g., 30 seconds).
        </Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • Keep truths and dares age-appropriate and respectful of everyone's boundaries
          {"\n"}• Be creative! Tailor challenges to the group's interests
          {"\n"}• Ensure everyone feels included and comfortable during the game
        </Text>
      </View>
    </ScrollView>
  );
