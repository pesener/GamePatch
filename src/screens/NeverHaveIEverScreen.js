    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Players take turns revealing things they've never done. The goal is to 
          learn fun and surprising facts about each other while trying to stay in 
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          {"\n"}• Drink: If playing a drinking version, each player has a drink
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Players take turns making statements that start with "Never have I ever..." 
          followed by something they have never done. Other players who have done 
          the stated action must take an action, like losing a point or taking a drink.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • Players agree on the number of tokens or points each player starts with (e.g., 5)
          {"\n"}• The youngest player typically begins, and the game proceeds clockwise
        </Text>
        ...
        <Text style={styles.text}>
          ...
          {"\n"}• The game continues until only one player remains or players agree to end the game
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          The last player remaining with tokens or points wins. In the drinking 
          version, there's no formal winner—it's all about the fun!
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Players make rapid-fire statements, and everyone must respond quickly.
        </Text>

        <Text style={styles.boldText}>Penalty Actions:</Text>
        <Text style={styles.text}>
          Instead of losing points or drinking, players perform funny dares or challenges.
        </Text>

        <Text style={styles.boldText}>Safe Zone:</Text>
        <Text style={styles.text}>
          Allow players to skip responding once per game if they're uncomfortable answering.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • Keep statements fun and lighthearted. Avoid overly personal or embarrassing 
          topics unless everyone is comfortable
          {"\n"}• Mix up simple and creative statements to keep the game interesting
          {"\n"}• Respect boundaries—players can opt not to respond without penalty if needed
        </Text>
      </View>
    </ScrollView>
  );
