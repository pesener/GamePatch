      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            {"\n"}• Double Letter (DL): Doubles the score of the letter placed
            on it.
            {"\n"}• Triple Letter (TL): Triples the score of the letter placed
            on it.
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            • The player with the letter closest to "A" (excluding blanks)
            starts.
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            {"\n"}• You can use regular words, but no proper nouns,
            abbreviations, prefixes, suffixes, or hyphenated words are allowed.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            {"\n"}• Save high-value letters (like Q, Z, J, X) for premium
            squares.
            {"\n"}• Use two-letter words (e.g., "QI," "OX") to score
            efficiently.
          </Text>
        </View>
      </View>
