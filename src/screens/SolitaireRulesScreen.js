    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          foundations according to specific rules until all cards are placed in
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • Cards in the tableau are arranged in descending order (King to Ace)
          and must alternate in color (e.g., red 6 on black 7)
          {"\n"}• Only face-up cards can be moved
          {"\n"}• A sequence of cards can be moved together if they maintain the
        ...
        <Text style={styles.text}>
          • When you can't make a move on the tableau, draw cards from the stock
          pile
          {"\n"}• If the stock pile runs out, the waste pile can be turned over
          to form a new stock (based on your chosen rule set)
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Some versions limit the number of times you can pass through the stock
          pile.
        </Text>
      </View>
