    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Be the first player to score 500 points by being the first to play all
          your cards in each round and earning points based on the cards left in
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          {"\n"}• Play proceeds clockwise (or counterclockwise if a Reverse card
          is played)
        </Text>
        ...
        <Text style={styles.text}>
          ...
          {"\n"}• A Wild Draw Four can only be played if the player has no other
          playable cards
        </Text>
        ...
        <Text style={styles.text}>
          ...
          their turn ends
          {"\n"}• If another player catches them not saying UNO, they must draw
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • Stacking: Players can stack Draw Two or Wild Draw Four cards if they
          have one, forcing the next player to draw cumulatively
          {"\n\n"}• 7-0 Rule: When a 7 is played, the player may trade hands
          with another player. When a 0 is played, all players pass their hands
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          {"\n"}• Keep track of the colors opponents are playing to guess their
          remaining cards
