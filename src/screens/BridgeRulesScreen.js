      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Bridge is a partnership card game for four players. The goal is to
            win as many tricks as possible based on the contract agreed upon
            during bidding.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            {"\n"}• A bid specifies:
            {"\n"} - Number of Tricks: Total tricks over six that the
            partnership commits to winning (e.g., 1 means 7 tricks, 2 means 8
            tricks)
          ...
          <Text style={styles.text}>
            • Double: Challenges the opponents to meet their contract,
            increasing the score stakes
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            • The partnership that won the contract tries to fulfill it by
            winning the specified number of tricks
          </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Each trick beyond the first six contributes to the partnership's
            score based on the contract:
          ...
          <Text style={styles.text}>
            ...
            contracts
            {"\n"}• Slam Bonus: Awarded for bidding and making 12 (small slam)
            or 13 (grand slam) tricks
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            • Learn the basics of bidding conventions, like Stayman or
            Blackwood, to communicate effectively with your partner
            {"\n"}• Focus on counting high-card points (HCP) during bidding:
            {"\n"} - Ace = 4 points
            {"\n"} - King = 3 points
            {"\n"} - Queen = 2 points
            {"\n"} - Jack = 1 point
            {"\n"}• During play, watch for high cards played to deduce
