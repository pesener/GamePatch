    ...
    <ScrollView style={styles.container}>
      <View style={styles.contentContainer}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            • The board has 24 triangular spaces called points, divided into
            four quadrants:
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            {"\n"}• You may split the dice roll between two different checkers
            or use both dice for one checker
          ...
          <Text style={styles.text}>
            • Once all your checkers are in your home board (points 1-6), you
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            {"\n"}• A player can propose doubling the stakes at the start of
            their turn
