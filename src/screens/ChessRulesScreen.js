      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            {"\n"}• The Queen is placed on her matching color square (white
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            {"\n"}• The King is not in check, does not move through a square
            under attack, and does not land in check.
          </Text>

          <Text style={styles.boldText}>En Passant:</Text>
          <Text style={styles.text}>
            • A pawn can capture an opposing pawn that has moved 2 squares
            forward from its starting position, bypassing the square where it
          ...
          <Text style={styles.text}>
            • When a pawn reaches the last rank (opponent's back row), it must
            be promoted to any piece (except a King), usually a Queen.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            • The player to move has no legal moves, and the King is not in
            check.
          </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            {"\n"}• Develop all your pieces before moving the same piece
            multiple times.
