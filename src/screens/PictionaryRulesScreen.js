    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Players guess words or phrases based on drawings created by their teammates. 
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          becomes the "drawer" and attempts to draw clues for their team to guess 
          the word or phrase.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • The drawer selects a word or phrase from the Pictionary card or list
        ...
        <Text style={styles.text}>
          ...
          {"\n"}• If the team guesses the word or phrase within the time limit, 
          they score a point
        </Text>

        <Text style={styles.boldText}>3. Turns</Text>
        <Text style={styles.text}>
          Teams take turns, and a different player becomes the drawer each time.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Both teams draw and guess the same word simultaneously. The first team 
          to guess correctly scores a point.
        </Text>

        <Text style={styles.boldText}>Speed Round:</Text>
        <Text style={styles.text}>
          Teams try to guess as many words as possible within a set time limit.
        </Text>

        <Text style={styles.boldText}>Custom Categories:</Text>
        <Text style={styles.text}>
          Add specific themes, like holidays, food, or famous landmarks, for more fun.
        </Text>
      </View>
