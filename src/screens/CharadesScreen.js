    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Players act out words or phrases without speaking, and their teammates 
          guess the word or phrase within a time limit. The team with the most 
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • A list of words or phrases (e.g., movies, books, famous people, actions)
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          The game is played in rounds. In each round, one player acts out a word 
          or phrase while their teammates try to guess it.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          ...
          {"\n"}• The actor uses gestures, movements, and facial expressions to 
          convey the word or phrase without:
          {"\n"}  - Speaking or making sounds
          {"\n"}  - Writing letters, numbers, or the word itself
          {"\n"}  - Pointing to objects in the room (unless agreed upon in advance)
        </Text>

        <Text style={styles.boldText}>2. Guessing</Text>
        <Text style={styles.text}>
          • The actor's team shouts out guesses while the actor continues acting
          {"\n"}• If the team guesses correctly before time runs out, they score a point
        </Text>

        <Text style={styles.boldText}>3. Turns</Text>
        <Text style={styles.text}>
          Teams alternate turns, with a new player acting out the next word or phrase.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • The game ends after a predetermined number of rounds or when the list 
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Both teams act out the same word or phrase at the same time. The first 
        ...
        <Text style={styles.text}>
          Players are allowed to mime props or environments to enhance their acting.
        </Text>

        <Text style={styles.boldText}>Custom Categories:</Text>
        <Text style={styles.text}>
          Players can create categories tailored to their group, like "Inside Jokes" 
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          • Break down complex phrases into smaller parts and act them out sequentially
          {"\n"}• Use common signals:
