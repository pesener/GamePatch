    ...
    <ScrollView style={styles.container}>
      <View style={styles.contentContainer}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            • Pay the listed amount to the bank (e.g., Income Tax or Luxury
            Tax).
          </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            • Players can trade money, properties, and Get Out of Jail Free
            cards.
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            If you owe more than you can pay, you must sell properties or
            declare bankruptcy:
